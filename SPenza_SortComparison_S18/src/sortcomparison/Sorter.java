...
public interface Sorter {
	...
	/**
	 * Sorts part or all of the list, data, in ascending order. quickSort() must: -
	 * Call the insertionSort() function in this interface for segments of size 15
	 * or less. - Use the median-of-three method to prevent O(n^2) running time for
	 * sorted data sets - Call the partition() function in this interface to do its
	 * partitioning.
	 * 
	 * @param data
	 *            The list of elements to sort
	 ...
	 * Sorts part or all of a list in ascending order.
	 * 
	 * mergeSort() must: - Call the insertionSort() function in this interface for
	 * segments of size 15 or less. - Call the merge() function in this interface to
	 * do its merging.
	 * 
	 * @param data
